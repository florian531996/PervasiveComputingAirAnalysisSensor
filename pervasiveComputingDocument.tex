...
It is also possible to later build on the air quality information system by integrating the data into other technical devices. For example, windows could be automatically closed, air filters regulated and car navigation system could propose routes based on the air quality. However, this is out-of-scope for a first technical implementation in Perheim.
...
In the most straight-forward approach, the local municipality and thus indirectly the tax payer is responsible for covering all costs. The service is then provided to all citizens of Perlheim free of charge. This is a sensible idea because not only the citizens benefit from the air quality information system, but also the municipality itself.
