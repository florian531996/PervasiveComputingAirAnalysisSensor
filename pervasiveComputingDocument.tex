...
The basic idea is to build an air quality sensor out of an Arduino and multiple other sensors, distribute numerous of those air quality sensors throughout Perheim, gather the measured data into a central database and display this data into an easy to use and visually appealing application. The following chapters will cover each of these steps in detail.
...
\begin{figure}[htbp]
	...
	\caption{Mockup of frontend homepage with Mannheim as displayed region}
